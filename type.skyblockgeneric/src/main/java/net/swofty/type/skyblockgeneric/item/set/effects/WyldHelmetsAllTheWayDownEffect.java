...
public final class WyldHelmetsAllTheWayDownEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Helmets All The Way Down"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Regain +1 Rift Time after killing a monster.");
    }

    @Override
    public int getRequiredPieces(ArmorSetContext context) { return 1; }
    @Override
    public Set<ItemType> getRequiredItems() { return Set.of(ItemType.WYLD_HELMET); }
}
