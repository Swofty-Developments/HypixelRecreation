...
public final class ProtectorDragonProtectiveBloodEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Protective Blood"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Increases each armor piece's Defense by 1% for every percent of missing Health.");
    }
