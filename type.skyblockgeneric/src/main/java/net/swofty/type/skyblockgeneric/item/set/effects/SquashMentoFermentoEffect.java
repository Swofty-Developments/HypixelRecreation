...
public final class SquashMentoFermentoEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Mento Fermento"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants a chance to harvest Fermento and " + statistic(FARMING_FORTUNE, context.tierValue(0, 20, 40, 60)) + ".");
    }
    ...
    public ItemStatistics getStatistics(ArmorSetContext context) {
        return baseStatistic(FARMING_FORTUNE, context.tierValue(0, 20, 40, 60));
    }
}
