...
public final class MagmaLordFireproofEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Fireproof"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants immunity to Crimson Isle lava.");
    }
