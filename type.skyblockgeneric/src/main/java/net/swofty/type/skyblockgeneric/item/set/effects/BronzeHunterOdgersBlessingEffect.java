...
public final class BronzeHunterOdgersBlessingEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants " + statistic(TROPHY_FISH_CHANCE, context.tierValue(0, 3, 4, 5)) + ".");
    }
    ...
    public ItemStatistics getStatistics(ArmorSetContext context) {
        return baseStatistic(TROPHY_FISH_CHANCE, context.tierValue(0, 3, 4, 5));
    }
}
