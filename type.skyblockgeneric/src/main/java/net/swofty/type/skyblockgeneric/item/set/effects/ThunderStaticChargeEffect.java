...
public final class ThunderStaticChargeEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Static Charge"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Periodically gains Static Charges that add damage to the next hit.");
    }
