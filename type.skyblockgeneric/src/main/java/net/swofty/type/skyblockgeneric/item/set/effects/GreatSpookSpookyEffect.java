...
public final class GreatSpookSpookyEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Spooky"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Enables the Great Spook Staff to spook other players.");
    }
