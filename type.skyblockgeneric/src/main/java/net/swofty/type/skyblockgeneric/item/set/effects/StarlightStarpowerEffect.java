...
public final class StarlightStarpowerEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Starpower"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Doubles Starfall's duration and increases its radius by 1 block.");
    }
