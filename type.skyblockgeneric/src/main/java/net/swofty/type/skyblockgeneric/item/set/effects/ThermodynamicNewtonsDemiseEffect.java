...
public final class ThermodynamicNewtonsDemiseEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Newton's Demise"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Increases the Attack Speed cap by 50.");
    }
