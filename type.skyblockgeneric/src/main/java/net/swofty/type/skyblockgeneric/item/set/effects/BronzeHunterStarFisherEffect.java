...
public final class BronzeHunterStarFisherEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Star Fisher"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants <sbstat:fishing_speed:+0.2> per Upgrade Star on the armor.");
    }
