...
public final class PowerWitherWitherbornEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Witherborn"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Spawns a wither minion every 30 seconds that seeks and explodes on nearby enemies.");
    }
