...
public final class HelianthusFeastEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Combines the Tater, Cropie, Squash, and Fermento bonuses and grants " + statistic(FARMING_FORTUNE, context.tierValue(0, 25, 50, 75)) + ".");
    }
