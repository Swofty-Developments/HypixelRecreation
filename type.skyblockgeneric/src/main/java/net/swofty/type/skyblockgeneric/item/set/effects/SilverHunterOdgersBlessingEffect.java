...
public final class SilverHunterOdgersBlessingEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants " + statistic(TROPHY_FISH_CHANCE, context.tierValue(0, 5, 7.5, 10)) + ".");
    }
    ...
    public ItemStatistics getStatistics(ArmorSetContext context) {
        return baseStatistic(TROPHY_FISH_CHANCE, context.tierValue(0, 5, 7.5, 10));
    }
}
