...
public final class RabbitSpringsneakEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Springsneak"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants Jump Boost II while sneaking.");
    }
