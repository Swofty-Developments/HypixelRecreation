...
public final class GoldHunterOdgersBlessingEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants " + statistic(TROPHY_FISH_CHANCE, context.tierValue(0, 10, 15, 20)) + ".");
    }
    ...
    public ItemStatistics getStatistics(ArmorSetContext context) {
        return baseStatistic(TROPHY_FISH_CHANCE, context.tierValue(0, 10, 15, 20));
    }
}
