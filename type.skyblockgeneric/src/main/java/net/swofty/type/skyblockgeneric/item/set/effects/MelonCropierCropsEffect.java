...
public final class MelonCropierCropsEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Cropier Crops"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants a chance to harvest Cropie and " + statistic(FARMING_FORTUNE, context.tierValue(0, 10, 20, 30)) + ".");
    }
    ...
    public ItemStatistics getStatistics(ArmorSetContext context) {
        return baseStatistic(FARMING_FORTUNE, context.tierValue(0, 10, 20, 30));
    }
}
