...
public final class BerserkerBerserkEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Halves Health and Defense and reduces health-consuming ability costs by " + tier(context, "20%", "40%", "60%") + ".");
    }
