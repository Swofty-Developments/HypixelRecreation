...
public final class MagmaAbsorbEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Every 10 Magma Cubes killed while wearing the set grants <sbstat:health:+1> and <sbstat:intelligence:+1>, up to +200 each.");
    }
