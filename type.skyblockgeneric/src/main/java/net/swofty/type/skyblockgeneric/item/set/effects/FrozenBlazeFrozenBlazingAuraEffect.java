...
public final class FrozenBlazeFrozenBlazingAuraEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Frozen Blazing Aura"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Damages mobs within 5 blocks for 300 plus 3% of their maximum Health each second and applies Slowness I.");
    }
