...
public final class GoblinSmartMinerEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Smart Miner"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Sets Intelligence to 0 and grants <sbstat:mining_speed:+1> for every 15 Intelligence removed.");
    }
