...
public final class GlossyMineralGlossyMineralworksEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Glossy Mineralworks"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants " + statistic(MINING_SPREAD, context.tierValue(150, 300, 450, 600)) + " on Ores and Blocks.");
    }
    ...
    public ItemStatistics getStatistics(ArmorSetContext context) {
        return baseStatistic(MINING_SPREAD, context.tierValue(150, 300, 450, 600));
    }
}
