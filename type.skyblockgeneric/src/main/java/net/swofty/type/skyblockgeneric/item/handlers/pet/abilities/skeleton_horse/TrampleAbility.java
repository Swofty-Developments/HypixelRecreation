...
@PetAbilityRegistration(pet = PetHandler.SKELETON_HORSE, minimumRarity = Rarity.LEGENDARY, order = 2)
public final class TrampleAbility implements PetAbility {
    private static final double BASE = 0.75;
    private static final double PER_LEVEL = 0.0625;
