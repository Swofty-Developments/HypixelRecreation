...
public final class BlazeBlazingAuraEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Blazing Aura"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Damages mobs within 5 blocks for 3% of their maximum Health each second, capped at 5,000 damage.");
    }
