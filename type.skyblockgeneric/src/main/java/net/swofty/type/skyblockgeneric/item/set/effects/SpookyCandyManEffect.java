...
public final class SpookyCandyManEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Candy Man"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Grants +20% chance to find Green Candy and +5% chance to find Purple Candy.");
    }
