...
public final class RevenantTrollingTheReaperEffect extends ArmorSetEffect {
    @Override
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Healing Wands are 50% more effective and grants <sbstat:defense:+100> against Zombies.");
    }
