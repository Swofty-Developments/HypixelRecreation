...
public final class BatPersonBatPowersActivateEffect extends ArmorSetEffect {
    @Override
    public String getName() { return "Bat Powers Activate!"; }
    ...
    public List<String> getDescription(ArmorSetContext context) {
        return List.of("Upgrades the Grappling Hook and grants +5% chance to find Purple Candy.");
    }
